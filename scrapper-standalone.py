...
mycursor.execute("CREATE TABLE IF NOT EXISTS bulk_deals (id INT AUTO_INCREMENT PRIMARY KEY, security_code INT, security_name VARCHAR(255), client_name VARCHAR(255), deal_type VARCHAR(255), quantity INT, price FLOAT, deal_date DATE)")
...
def scrape_and_store():
    ...
    for row in rows[1:]:
        ...
        sql = "INSERT INTO bulk_deals (security_code, security_name, client_name, deal_type, quantity, price, deal_date) VALUES (%s, %s, %s, %s, %s, %s, %s)"
        val = (security_code, security_name, client_name,
               deal_type, quantity, price, deal_date)
